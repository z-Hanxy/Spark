        ...
        <div className="rounded-2xl bg-green-50 p-12 text-center">
          ...
          {totalDue === 0 && (
            <button
              ...
              className="mt-6 cursor-pointer rounded-lg bg-indigo-600 px-6 py-2 text-sm font-medium text-white hover:bg-indigo-700"
            >
              返回
            </button>
          )}
      ...
      <div className={`flex w-full max-w-lg flex-col items-center rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-xl transition-all duration-500 ${showAnswer ? 'min-h-[320px]' : 'min-h-[240px]'}`}>
        ...
        {!showAnswer ? (
          <button
            ...
            className="mt-4 cursor-pointer rounded-xl bg-indigo-600 px-8 py-3 text-base font-semibold text-white shadow-md transition-all hover:bg-indigo-700 hover:shadow-lg active:scale-[0.98]"
          >
            显示答案
          </button>
        ) : (
          <>
            <div className="mb-8 w-full rounded-xl bg-gray-50 p-6 text-center">
              <span className="mb-2 inline-block rounded-full bg-amber-100 px-3 py-0.5 text-xs font-medium text-amber-700">
                Answer
              </span>
            ...
            <div className="flex w-full gap-3">
              <button
                ...
                className="flex-1 cursor-pointer rounded-xl border-2 border-red-300 bg-red-50 py-3 text-sm font-bold text-red-600 transition-all hover:bg-red-100 hover:shadow-md active:scale-[0.97]"
              >
              ...
              <button
                ...
                className="flex-1 cursor-pointer rounded-xl border-2 border-yellow-300 bg-yellow-50 py-3 text-sm font-bold text-yellow-600 transition-all hover:bg-yellow-100 hover:shadow-md active:scale-[0.97]"
              >
                <div className="text-lg">🟡</div>
                <div>模糊</div>
              </button>
              <button
                ...
                className="flex-1 cursor-pointer rounded-xl border-2 border-green-300 bg-green-50 py-3 text-sm font-bold text-green-600 transition-all hover:bg-green-100 hover:shadow-md active:scale-[0.97]"
              >
                <div className="text-lg">🟢</div>
                <div>记住</div>
              </button>
