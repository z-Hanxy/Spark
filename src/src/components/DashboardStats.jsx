...
export default function DashboardStats({ refreshKey }) {
  ...
  const items = [
    { label: '已掌握', value: stats.mastered, color: 'bg-green-50 border-green-200', textColor: 'text-green-700', desc: 'repetitionCount ≥ 7' },
    { label: '抗争中', value: stats.struggling, color: 'bg-amber-50 border-amber-200', textColor: 'text-amber-700', desc: '尚未掌握的卡片' },
    { label: '今日待复习', value: stats.dueToday, color: 'bg-indigo-50 border-indigo-200', textColor: 'text-indigo-700', desc: 'nextReviewDate ≤ now' },
    { label: '今日完成', value: stats.doneToday, color: 'bg-emerald-50 border-emerald-200', textColor: 'text-emerald-700', desc: '最后结果为🟢的卡片' },
  ]
