              ...
              >
                ...
                {isTouch && (
                  <button
                    ...
                    className="ml-1 shrink-0 cursor-pointer rounded-lg p-1 text-gray-400 hover:bg-gray-200"
                  >
                ...
                {isTouch && menuFolderId === folder.id && (
                  ...
                  >
                    <button
                      onClick={() => { setMenuFolderId(null); setDeleteTarget({ id: folder.id, name: folder.name }) }}
