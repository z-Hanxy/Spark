              ...
              {cards.map((card) => {
                ...
                return (
                  <div
                    ...
                    className="group flex cursor-pointer items-start justify-between rounded-lg px-3 py-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-100"
                  >
        ...
        <div className="space-y-4">
          ...
          {cardType === 'cloze' ? (
            <div>
              ...
              <textarea
                ...
                placeholder="请输入整段内容，例如：中国四大发明是指造纸术、指南针、火药和印刷术。"
                rows={6}
                autoFocus
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <textarea
                    value={matchLeftText}
                    onChange={(e) => { setMatchLeftText(e.target.value); setMatchError('') }}
                    placeholder={'造纸术\n指南针\n火药\n印刷术'}
                    rows={6}
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 resize-none"
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => { setMatchRightText(e.target.value); setMatchError('') }}
                    placeholder={'蔡伦\n航海\n军事\n知识传播'}
                    rows={6}
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 resize-none"
                  />
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              disabled={cardType === 'cloze' ? !clozeText.trim() : cardType === 'match' ? (!matchLeftText.trim() || !matchRightText.trim()) : (!question.trim() || !answer.trim())}
